...
def test_validate_5_leaves():
    ...
    is_valid = mt.validate_proof(proof, '3f79bb7b435b05321651daefd374cdc681dc06faa65e374e38337b88ca046dea',
                                 'd71f8983ad4ee170f8129f1ebcdd7440be7798d8e1c80420bf11f1eced610dba')
    assert is_valid == True

    proof = mt.get_proof(1)
    is_valid = mt.validate_proof(proof, '3e23e8160039594a33894f6564e1b1348bbd7a0088d42c4acb73eeaed59c009d',
                                 'd71f8983ad4ee170f8129f1ebcdd7440be7798d8e1c80420bf11f1eced610dba')
    assert is_valid == True
...
def test_sha224():
    ...
    is_valid = mt.validate_proof(mt.get_proof(0), '90a3ed9e32b2aaf4c61c410eb925426119e1a9dc53d4286ade99a809',
...
def test_sha256():
    ...
    is_valid = mt.validate_proof(mt.get_proof(0), '1516f000de6cff5c8c63eef081ebcec2ad2fdcf7034db16045d024a90341e07d',
...
def test_sha3_224():
    ...
    is_valid = mt.validate_proof(mt.get_proof(0), '6ed712b9472b671fd70bb950dc4ccfce197c92a7969f6bc2aa6b6d9f',
...
def test_keccak_256():
    ...
    mt.make_tree()
    assert mt.get_merkle_root() == '868ff89bfea2cb41195ab36c8ec7793ecf8d07701bc344a2817827585d3c18ac'
    assert mt.get_proof(0)[0][
               'right'] == 'd9bdff55f5a7943e3d0267f5842f9063de3bc7faa4bf3e62fd96c4d5ca444aa4'
    is_valid = mt.validate_proof(mt.get_proof(0),
